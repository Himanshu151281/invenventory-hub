      ...
      <div className="mb-6 flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Get insights into your sales performance and trends.
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Projected growth by category</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg bg-muted/50">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Increase stock of "Electronics" category by 15% to meet projected demand growth.
                    </p>
                  </div>
                  
                  <div className="p-4 border rounded-lg bg-muted/50">
                    <h3 className="font-medium mb-1">Pricing Strategy</h3>
                    <p className="text-sm text-muted-foreground">
                      Consider a 5% price increase for "Audio" products based on consistent demand.
                    </p>
                  </div>
                  
                  <div className="p-4 border rounded-lg bg-muted/50">
                    <h3 className="font-medium mb-1">Marketing Focus</h3>
                    <p className="text-sm text-muted-foreground">
                      Allocate additional marketing budget to "Wearables" to capitalize on growth trend.
                    </p>
                  </div>
                </div>
              </CardContent>
